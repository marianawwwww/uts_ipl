                    ...
                    <tbody class="table-secondary">
                        <?php foreach ($mahasiswa as $row) : ?>
                            <tr>
                                ...
                                <td><?= $row['alamat']; ?></td>
                                <td>
                                    <a href="ubah.php?nim=<?= $row['nim']; ?>" class="btn btn-outline-dark btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a>
                                    <a href="hapus.php?nim=<?= $row['nim']; ?>" class="btn btn-dark btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['nama']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
